...
define('peepchat/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"peepchat","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"peepchat","version":"0.0.0+3d0aa6e1"},"exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("peepchat/app")["default"].create({"name":"peepchat","version":"0.0.0+3d0aa6e1"});
}
